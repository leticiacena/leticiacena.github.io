...
import 'package:oncolo/view/pages/web/tela_editar_paciente_web.dart';
...
class TelaListarPaciente extends StatefulWidget {
  const TelaListarPaciente({super.key});

  @override
  State<TelaListarPaciente> createState() => _TelaListarPaciente();
}

class _TelaListarPaciente extends State<TelaListarPaciente>
  ...
  chamarTelaEditar() {
    ...
    Navigator.push(
        context, MaterialPageRoute(builder: (context) => TelaEditarPaciente()));
  }
          ...
          Container(
            ...
            child: Column(
              children: [
                Stack(
                  children: [
                    Image.asset('assets/images/img_fundo_mobile.png',
                        height: altura / 5,
                        width: largura,
                        fit: BoxFit.fitWidth),
                    const Center(
                          ...
                          child: IconButton(
                            ...
                            onPressed: () {
                              Navigator.of(context).pushNamed(
                                  '/CadastrarPaciente'); // função para executar quando o botão de enviar for pressionado
                            },
                          ),
                        ),
                      ),
